...
```{r out.width="10%", fig.cap="Figure: Number of coloc regions for pairs of (module, trait) for all traits. Left: non-merged coloc regions. Right: merged coloc regions. Colors: Traits of various types.", fig.show='hold',fig.align='center'}
knitr::include_graphics(c("asset/2022/a.pdf", "asset/2022/b.pdf"), error = FALSE)
```
