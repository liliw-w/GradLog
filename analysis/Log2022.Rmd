...
-   Observation:
    ...
    (As for why the other modules don't have enriched h2, maybe that's because these modules are mostly zinc finger genes? as we discussed in [earlier section](Log2022.html#gene_SENP7).)
