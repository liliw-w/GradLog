...
Before we look at the partitioned $h^2$ of colocalized module in autoimmune diseases, see below for the coloc regions of diseases and modules. Five diseases have coloc regions, corresponding to 8 modules. Number in each cell is the number of coloc regions.

![](asset/2022/0608_immune_coloc_modules.png){width="50%"}
...
Among those coloc modules, only module 100 has enriched h2, for Crohns' disease and ibd. So, I looked at module 100.
