...
```{r fig.cap="Figure. Module v.s. #Genes. Bar height for module size. Red/blue bar for #cross mappable genes for each module. Left for genes cross mappable with any genes. Right for genes cross mappable with genes within the same module.", fig.show='hold', fig.align='center', out.width="50%"}
