...
```{r fig.cap=c("Power")}
knitr::include_graphics(c("0625_power.png"), error = FALSE)
```

Check [here](../docs/0625_power.png) for clearer version.
...
```{r fig.cap=c("TIE")}
knitr::include_graphics(c("0625_TIE.png"), error = FALSE)
```

Check [here](../docs/0625_TIE.png) for clearer version.
...
```{r}
knitr::include_graphics("qqplot.p_obs.eQTLGen.png", error = FALSE)
```
