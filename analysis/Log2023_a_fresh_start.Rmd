...
We observed from last week's results that it seems that PCO's p move toward ACAT/minP p when window sizes decrease. Therefore, we wanted to check if that pattern persists under smaller window sizes. So, I tried extreme window sizes, 10kb, 25kb, 50kb.
