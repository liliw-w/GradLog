...
## Re-thinking of segment-based idea
...
```{r out.width="50%", fig.cap="Figure: P value distribution under various factors of average log2 CPM. Only show small P < 1e-5", fig.show='hold',fig.align='center'}
...
## 3. Count based - Perform PCO (pick one region)
