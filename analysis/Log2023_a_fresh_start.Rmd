...
- Re-do segment-based by changing peak filtering from using average log2 CPM as cutoff to using log2 average CPM.
...
cutoff to be log2 ave cpm, instead of ave log2 cpm as last time.

Use median across segments instead of mean, as large variation expected across segments. [Use mean of one seg across individuals, as similar count expected for individuals.]
