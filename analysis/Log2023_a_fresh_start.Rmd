...
```{r out.width="25%", fig.cap="Figure: ", fig.show='hold',fig.align='center'}
...
### Compare to Dutte et. al

- Their idea

- How to compare with us?
...
## 3. Zicheng's experience on scataq

- Inflation
  
  Due to error of not doing rank normal.

- Caution on selecting window size for various cell types

- Caution on rank normal peaks for minor cell types
