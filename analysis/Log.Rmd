...
In order to check if keep increasing permutations will keep decreasing signals, I ran more permutations, i.e. 1, 5, 10, 15, 20. See section in `Dec 01`. The figures show that if we use FDR based on the combined chr and modules, maybe we should use 10 permutations rather than 1.
